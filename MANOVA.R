...
# Se declaran las variables independientes como factores
x1=factor(cX1)
x2=factor(cX2)
x3=factor(cX3)
...
# Análisis multivariante de la varianza considerando todas las variables dependientes
mod3<-manova(cbind(columnaI1,columnaI2,columnaI3,columnaI4)~x1*x2*x3)
summary(mod3)